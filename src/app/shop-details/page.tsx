...
const page = () => {
  return (
    <>
      <InnerPageHeader />
      <Breadcrumb title="Product Details" subtitle="Market Trend &amp; Analyst Behind The Scene of Industry." />
 
      <div className="shop-details-top-section pt-120 mb-120" id="scroll-section">
          ...
          <div className="row gy-md-5 gy-4">
                ...
                <div className="tab-content" id="v-pills-tabContent">
                  <div className="tab-pane fade show active" id="v-pills-img1" role="tabpanel">
                    <div className="shop-details-tab-img">
                      <Image width={960} height={270} src="/assets/img/innerpages/shop-details-tab-img1.jpg" alt="" />
                    </div>
                  </div>
                  <div className="tab-pane fade" id="v-pills-img2" role="tabpanel">
                    <div className="shop-details-tab-img">
                      <Image width={960} height={270} src="/assets/img/innerpages/shop-details-tab-img2.jpg" alt="" />
                    </div>
                  </div>
                  <div className="tab-pane fade" id="v-pills-img3" role="tabpanel" aria-labelledby="v-pills-img3-tab">
                    <div className="shop-details-tab-img">
                      <Image width={960} height={270} src="/assets/img/innerpages/shop-details-tab-img3.jpg" alt="" />
                    </div>
                  </div>
                  <div className="tab-pane fade" id="v-pills-img4" role="tabpanel" aria-labelledby="v-pills-img4-tab">
                    <div className="shop-details-tab-img">
                      <Image width={960} height={270} src="/assets/img/innerpages/shop-details-tab-img4.jpg" alt="" />
                    </div>
                  </div>
                </div>
            ...
            <div className="col-lg-6">
              <div className="shop-details-content">
                <h2>Corrosion Resistant Panels</h2>
                ...
                <div className="quantity-color-area">
                  ...
                  <div className="quantity-color">
                    ...
                    <ul className="color-list">
                      <li className="select-wrap selected"><span /></li>
                ...
                <div className="shop-details-btn">
                  <Link className="primary-btn1 black-bg" href="/checkout">
                    <span>Buy Now
                    </span>
                    <span>Buy Now
                    </span>
                  ...
                  <Link className="primary-btn1 transparent" href="/cart">
                    <span>Add To Cart
                    </span>
                    <span>Add To Cart
                    </span>
                ...
                <div className="product-info">
                  <ul className="product-info-list">
                    ...
                    <li> <span>Brand:</span> <Link href="/shop">Steel Edge</Link></li>
                ...
                <div className="payment-method">
                  ...
                  <ul className="payment-card-list">
                    <li><Image width={80} height={270} src="/assets/img/innerpages/icon/payment-img1.svg" alt="" /></li>
                    <li><Image width={80} height={270} src="/assets/img/innerpages/icon/payment-img2.svg" alt="" /></li>
                    <li><Image width={80} height={270} src="/assets/img/innerpages/icon/payment-img3.svg" alt="" /></li>
                    <li><Image width={80} height={270} src="/assets/img/innerpages/icon/payment-img4.svg" alt="" /></li>
                    <li><Image width={80} height={270} src="/assets/img/innerpages/icon/payment-img5.svg" alt="" /></li>
                    <li><Image width={80} height={270} src="/assets/img/innerpages/icon/payment-img6.svg" alt="" /></li>
                    <li><Image width={80} height={270} src="/assets/img/innerpages/icon/payment-img7.svg" alt="" /></li>
                  </ul>
                </div>
      ...
      <div className="shop-details-description-section mb-120">
        <div className="container">
          <div className="row">
                    ...
                    <div className="row gy-5">
                      ...
                      <div className="col-lg-6 d-flex align-items-center justify-content-center">
                        <div className="description-tab-img">
                          <Image width={960} height={270} src="/assets/img/innerpages/shop-details-description-img1.png" alt="" className="d-lg-block d-none" />
                          <Image width={960} height={270} src="/assets/img/innerpages/shop-details-description-img2.png" alt="" className="d-lg-none d-block" />
                        </div>
                      </div>
                      <div className="col-lg-3">
                        <div className="description-content">
                          ...
                          <div className="review-list-area">
                            <ul className="comment">
                              <li>
                                <div className="single-comment-area">
                                  <div className="author-img">
                                    <Image width={960} height={270} src="/assets/img/innerpages/comment-author-01.jpg" alt="" />
                                  </div>
                                ...
                                <ul className="comment-replay">
                                  <li>
                                    <div className="single-comment-area">
                                      <div className="author-img">
                                        <Image width={960} height={270} src="/assets/img/innerpages/comment-author-02.jpg" alt="" />
                                      </div>
                                      <div className="comment-content">
                                        <div className="author-name-deg">
                                          <h6>Jacoline Juie,</h6>
                                  ...
                                  <li>
                                    <div className="single-comment-area">
                                      <div className="author-img">
                                        <Image width={960} height={270} src="/assets/img/innerpages/comment-author-03.jpg" alt="" />
                                      </div>
                                      <div className="comment-content">
                                        <div className="author-name-deg">
                                          <h6>Robert Smith,</h6>
                              ...
                              <li>
                                <div className="single-comment-area">
                                  <div className="author-img">
                                    <Image width={960} height={270} src="/assets/img/innerpages/comment-author-04.jpg" alt="" />
                                  </div>
                                  <div className="comment-content">
                                    <div className="author-and-review">
                                      <div className="author-name-deg">
                              ...
                              <li>
                                <div className="single-comment-area">
                                  <div className="author-img">
                                    <Image width={960} height={270} src="/assets/img/innerpages/comment-author-05.jpg" alt="" />
                                  </div>
                                  <div className="comment-content">
                                    <div className="author-and-review">
                                      <div className="author-name-deg">
