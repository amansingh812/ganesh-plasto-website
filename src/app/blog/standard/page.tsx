...
const page = () => {
    return (
        <>
            ...
            <div className="blog-standard-page pt-120 mb-120" id="scroll-section">
                <div className="container">
                    <div className="row justify-content-center mb-70">
                        <div className="col-lg-10 mb-80 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div className="blog-card blog-st magnetic-item">
                                <div className="blog-img-wrap">
                                    <Link className="blog-img" href="/blog/details">
                                        <Image width={1076} height={416} src="/assets/img/innerpages/blog-st-img1.jpg" alt="" />
                                    </Link>
                                ...
                                <div className="blog-content">
                                    ...
                                    <h5><Link href="/blog/details">Revolutionizing Production Then Future Of Industries And Factories Morbi Rhoncus Risus Felis Gravida.</Link></h5>
                        ...
                        <div className="col-lg-10 mb-80 wow animate fadeInDown" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div className="blog-card blog-st magnetic-item">
                                <div className="blog-img-wrap">
                                    <Link className="blog-img" href="/blog/details">
                                        <Image width={1076} height={416} src="/assets/img/innerpages/blog-st-img2.jpg" alt="" />
                                    </Link>
                                    <div className="blog-tag">
                                ...
                                <div className="blog-content">
                                    ...
                                    <h5><Link href="/blog/details">Sustainable Metals Reducingm Environment Impact Morbi rhoncus risus felis gravida Industry.</Link></h5>
                                    <Link href="/blog/details" className="read-btn">
                                        <span>Read More</span>
                                        <svg width={15} height={15} viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
                                            <g>
                        ...
                        <div className="col-lg-10 mb-80 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <div className="blog-card blog-st magnetic-item">
                                <div className="blog-img-wrap">
                                    <Link className="blog-img" href="/blog/details">
                                        <Image width={1076} height={416} src="/assets/img/innerpages/blog-st-img3.jpg" alt="" />
                                    </Link>
                                    <div className="blog-tag">
                                ...
                                <div className="blog-content">
                                    <div className="blog-meta">
                                        <ul>
                                            <li><Link className="blog-date" href="/blog">17 August, 2025</Link></li>
                                            <li><span>8 comment</span></li>
                                        </ul>
                                    </div>
                                    <h5><Link href="/blog/details">Expert Opinion Revolutionizin Production Industries Sustain Metals Reducingm Environment Impact.</Link></h5>
                                    <Link href="/blog/details" className="read-btn">
                                        <span>Read More</span>
                                        <svg width={15} height={15} viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
                                            <g>
                        ...
                        <div className="col-lg-10 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <div className="blog-card blog-st magnetic-item">
                                <div className="blog-img-wrap">
                                    <Link className="blog-img" href="/blog/details">
                                        <Image width={1076} height={416} src="/assets/img/innerpages/blog-st-img4.jpg" alt="" />
                                    </Link>
                                    <div className="blog-tag">
                                ...
                                <div className="blog-content">
                                    <div className="blog-meta">
                                        <ul>
                                            ...
                                            <li><span>6 comment</span></li>
                                        </ul>
                                    </div>
                                    <h5><Link href="/blog/details">Why Institutional Bit Pricing Matters For Your Trade Pulse Manufacturin Factories News &amp; Working.</Link></h5>
                                    <Link href="/blog/details" className="read-btn">
                                        <span>Read More</span>
                                        <svg width={15} height={15} viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
                                            <g>
