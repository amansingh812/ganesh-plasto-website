...
const page = () => {
    return (
        <>
            ...
            <div className="blog-sidebar-page pt-120 mb-120" id="scroll-section">
                                ...
                                <div className="single-widget mb-30">
                                    ...
                                    <div className="recent-post-widget mb-25">
                                        <div className="recent-post-img">
                                            <Link href="/blog/details"><Image width={92} height={71} src="/assets/img/innerpages/popular-post-img1.png" alt="" /></Link>
                                        </div>
                                    ...
                                    <div className="recent-post-widget mb-25">
                                        <div className="recent-post-img">
                                            <Link href="/blog/details"><Image width={92} height={71} src="/assets/img/innerpages/popular-post-img2.png" alt="" /></Link>
                                        </div>
                                        <div className="recent-post-content">
                                    ...
                                    <div className="recent-post-widget">
                                        <div className="recent-post-img">
                                            <Link href="/blog/details"><Image width={92} height={71} src="/assets/img/innerpages/popular-post-img3.png" alt="" /></Link>
                                        </div>
                                        <div className="recent-post-content">
