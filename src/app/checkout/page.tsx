...
const CheckoutPage: React.FC = () => {
  ...
  const calculateSubtotal = (): number => {
    ...
    return (
        <>
            <InnerPageHeader />
            <Breadcrumb title="Checkout" subtitle="Market Trend &amp; Analyst Behind The Scene of Industry." />
            <div className="checkout-page pt-120 mb-120" id="scroll-section">
                                            ...
                                            <div className="col-md-12">
                                                <div className="form-inner2">
                                                    <div className="form-check">
                                                        <input className="form-check-input" type="checkbox"  id="contactCheck11" />
