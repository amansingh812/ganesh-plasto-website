...
const Header1: React.FC = () => {
    ...
    const isServiceActive: boolean = serviceRoutesPath.some((path: string) => pathname.startsWith(path));
    ...
    const isSProjectPathActive: boolean = projectpaths.some((path: string) => pathname.startsWith(path));
    ...
    const isInnerPagetPathActive: boolean = innerPagePaths.some((path: string) => pathname.startsWith(path));
                                        ...
                                        <div className="container">
                                            <div className="row gy-lg-5">
                                                <div className="col-lg-3">
                                                    <div className={`single-menu-item ${pathname === "/" ? "active" : ""}`}>
